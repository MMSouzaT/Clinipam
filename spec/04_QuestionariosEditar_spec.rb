describe 'Questionarios', :questE do
    ...
    it 'Editar' do 
        ...
        find('.btn-padrao', text: 'SALVAR').click
        #preenchendo campo destinatário
        ...
        find('.btn-padrao', text: 'SALVAR').click
        #preenchendo campo data inicial
